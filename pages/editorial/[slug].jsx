...
export async function getServerSideProps(context) {
  ...
  // const res = await fetch(`http://localhost:3000/api/editorial/${slug}`);
  
  const res = await fetch(`https://tneit.vercel.app//api/editorial/${slug}`);
